...
console.log('👥 CRIANDO ADMINISTRADORES COM ESTRUTURA CORRETA');
console.log('==============================================');

async function criarAdminCorreto() {
  try {
    ...
    // Criar administradores com estrutura correta
    ...
    for (const admin of administradores) {
      console.log(`\n🔄 Criando administrador: ${admin.email}`);
      ...
      if (insertError) {
        console.error(`❌ Erro ao criar ${admin.email}:`, insertError);
      } else {
...
// Executar criação
criarAdminCorreto().catch(console.error);
