    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={clsx(
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <h1 className="text-xl font-bold text-gray-800">Digitalização de Abaixo-Assinados</h1>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="bg-white shadow-sm border-b border-gray-200">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={signOut}
                className="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 px-3 py-1 rounded-lg hover:bg-gray-100 transition-colors"
